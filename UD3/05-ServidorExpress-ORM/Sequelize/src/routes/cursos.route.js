...
import { validar, validarId, validarPatch } from '../validators/cursos.validator.js';
...
// PATCH - Actualizar Curso parcialmente
router.patch('/cursos/:id', validarId, validarPatch, updatePatchCurso);
